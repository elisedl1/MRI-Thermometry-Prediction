...
def train_network(config, args, model,test_ids, train_ids, valid_ids,image_path,thermometry_path): # data_ds change to test_ids and train_ids, valid_ids
    ...
    logging.info('Energy Level: 500J - Epochs: {} - Learning Rate: {} - Batch Size: {} - Extra: Augmentation(Flipped Horizontal)'.format(config.epochs, config.lr, config.batch_size))
...
if __name__ == '__main__':
    ...
    MRI_path  = "E:\Documents\MRgLITT\data\\500J\original\preprocessed\histogram_equalized"
    ...
    if not test :  # training
        ...
        output_model_path = output_model_path = "E:\\Documents\\MRgLITT\\data\\500J\\fixed_outputs"
